...
def pic_random(input_message):
  ...
  value_i = [
    ...
    ['嘉夜'],['祈梨'],['偶像大師灰姑娘女孩'],['卯月'],['凜'],['未央'],['美空']
    ]

  input_message = value_i[random.randint(0,len(value_i))][0]
...
### 伊麗莎白牧場 ###
  ...
  if input_message in ['鈴','リン','森近鈴','松鼠','遊俠鈴']:
    value_i = [
...
### 月光學院 ###
  ...
  if input_message in ['月光學院','ルーセント学院']:
    value_i = [
  ...
  if input_message in ['美咲','ミサキ','玉泉美咲','眼球法','萬聖美咲']:
    value_i = [
  ...
  if input_message in ['伊緒','イオ','支倉伊緒','魅魔','老師','伊歐派','泳裝伊緒']:
    value_i = [
  ...
  if input_message in ['鈴奈','スズナ','美波鈴奈','暴弓','爆弓','模特兒','數學白癡','泳裝鈴奈']:
    value_i = [
...
### ラビリンス ###
### 拉比林斯 ###
  if input_message in ['拉比林斯','ラビリンス']:
    value_i = [
  ...
  if input_message in ['靜流','シズル','星野靜流','姐姐','姊姊','弟控','情人節靜流']:
    value_i = [
  ...
  if input_message in ['妹弓','梨乃','璃乃','リノ','智障','笨蛋','衣之咲璃乃','奇幻璃乃']:
    value_i = [
...
### フォレスティエ ###
### 森林守衛 ###
  if input_message in ['美里','愛川美里','ミサト','聖母','美里老師','水母','泳裝美里']:
    value_i = [
  ...
  if input_message in ['碧','アオイ','雙葉碧','香菜弓'] or (input_message[:2] == '邊緣' and len(input_message) <= 4) :
    value_i = [
  ...
  if input_message in ['初音','ハツネ','柏崎初音','睡美人','泳裝初音']:
    value_i = [
...
### ヴァイスフリューゲル ランドソル支部 ###
### 純白之翼 ###
  if input_message in ['純白之翼','ヴァイスフリューゲル ランドソル支部','純白之翼 蘭德索爾分部','奇葩公會']:
    value_i = [
  ...
  if input_message in ['妮諾','ニノン','扇子','忍者','江戶妮諾']:
    value_i = [
  ...
  if input_message in ['莫妮卡','モニカ','毛二力','Monika','monika','魔法少女莫妮卡']:
    value_i = [
    ['跳到just monika彩蛋'],
  ...
  if input_message in ['空花','クウカ','抖M','抖m','江戶空花'] :
    value_i = [
  ...
  if input_message in ['步未','アユミ','石橋步未','路人妹' ,'路人','奇幻步未'] :
    value_i = [
  ...
  if input_message in ['雪','アユミ','小雪','虹村雪','雪哥','偽娘','女装大佬','自戀狂'] :
    value_i = [
...
### サレンディア救護院 ###
### 救護院 ###
  if input_message in ['咲戀救護院','サレンディア救護院','救護院']:
    value_i = [
  ...
  if input_message in ['咲戀','咲戀媽媽','充電寶','泳媽','媽','サレン','泳裝咲戀','聖誕咲戀']:
    value_i = [
  ...
  if input_message in ['鈴莓','スズメ','女僕','恐怖份子','天野鈴莓','正月鈴莓','泳裝鈴莓']:
    value_i = [
  ...
  if input_message in ['綾音','アヤネ','北條綾音','熊錘','噗吉','聖誕綾音']:
    value_i = [
  ...
  if input_message in ['胡桃','クルミ','栗林胡桃','聖誕胡桃']:
    value_i = [
...
### メルクリウス財団 ###
### 財團 ###
  if input_message in ['墨丘利財團','メルクリウス財団','財團']:
    value_i = [
  ...
  if input_message in ['秋乃','アキノ','聖誕秋乃','墨丘利財團唯一指定三星','財團之恥']:
    value_i = [
  ...
  if input_message in ['優花梨','聖誕優花梨','ユカリ','酒鬼']:
    value_i = [
  ...
  if input_message in ['珠希','タマキ','宮坂珠希','貓劍','貓賊','泳裝珠希']:
    value_i = [
  ...
  if input_message in ['美冬','ユカリ','大神美冬','屠龍者','打工仔','泳裝美冬']:
    value_i = [
...
### カォン自警団 ###
### 哞哞自衛隊 ###
  if input_message in ['哞哞自衛隊','自衛隊','カォン自警団']:
    value_i = [
  ...
  if input_message in ['真步','マホ','姬宫真步','真步公主','公主病','泳裝真步']:
    value_i = [
  ...
  if input_message in ['霞','カスミ','驢妹','偵探','水瀨祈','魔法少女霞','阿里巴巴大霞','阿里巴巴大俠']:
    value_i = [
    ['繪師: AJ-pixiv', 'https://i.imgur.com/i9BKQpj.jpg'],
  ...
  if input_message in ['真琴','マコト','安藝真琴','月月','泳裝真琴']:
    value_i = [
  ...
  if input_message in ['香織','カオリ','琉球犬','狗拳','喜屋武香織','一拳超狗','泳裝香織'] :
    value_i = [
...
### トワイライトキャラバン ###
### 暮光流星群 ###
  if input_message in ['暮光流星群','トワイライトキャラバン']:
    value_i = [
  ...
  if input_message in ['中二','アンナ','杏奈','修特帕魯','疾風之冥姬','泳裝杏奈']:
    value_i = [
  ...
  if input_message in ['流夏','ルカ','太刀洗流夏','大姐頭','流夏姐','泳裝流夏']:
    value_i = [
  ...
  if input_message in ['惠理子','エリコ','病嬌','情人節惠理子']:
    value_i = [
  ...
  if input_message in ['七七香','ナナカ','丹野七七香','收藏家','nnk','眼鏡法','77香','泳裝七七香']:
    value_i = [
  ...
  if input_message in ['深月','ミツキ','宵濱深月','獨眼惡魔','藥劑師']:
    value_i = [
...
### 偶像團 ###
### カルミナ ###
  if input_message in ['慈樂之音','偶像團','カルミナ']:
    value_i = [
  ...
  if input_message in ['紡希','ツムギ','繭宮紡希','萬聖紡希']:
    value_i = [
  ...
  if input_message in ['千歌','聖千','チカ','聖歌','聖誕千歌']:
    value_i = [
  ...
  if input_message in ['小望','望','ノゾミ','偶像','櫻井望','公車','公車望','聖誕小望']:
    value_i = [
...
### 惡魔偽王國軍 ###
### ディアボロス ###
  if input_message in ['惡魔偽王國軍','ディアボロス','Diabolos']:
    value_i = [
  ...
  if input_message in ['茜里','妹法','アカネ','惡魔雙子','雙子惡魔','天使茜里']:
    value_i = [
  ...
  if input_message in ['依里','ヨリ','姐法','姊法','天使依里']:
    value_i = [
  ...
  if input_message in ['台女','布丁','ミヤコ','宮子','幽靈','子宮','萬聖宮子']:
    value_i = [
  ...
  if input_message in ['忍','シノブ','鬼父','上喜忍','骷髏老爸','萬聖忍']:
    value_i = [
  ...
  if input_message in ['伊莉亞','伊莉雅','イリヤ','吸血鬼','自爆','伊莉亞·奧恩斯坦','聖誕伊莉亞']:
    value_i = [
...
### トゥインクルウィッシュ ###
### 破曉之星 ###
  if input_message in ['破曉之星','トゥインクルウィッシュ']:
    value_i = [
  ...
  if input_message in ['優衣','ユイ','草野優衣','ue','UE','Ue','公主優衣','正月優衣','儀式服優衣']:
    value_i = [
  ...
  if input_message in ['日和','ヒヨリ','春咲日和','貓拳','正月日和','公主日和']:
    value_i = [
  ...
  if input_message in ['怜','レイ','士條怜','怜大人','正月怜','萬聖怜']: #我的頭像
    value_i = [
  ...
  if input_message in ['優衣','ユイ','UE','ue','優依']:
    value_i = [
...
### リトルリリカル ###
### 小小甜心 ###
  if input_message in ['小小甜心','リトルリリカル','27歲']:
    value_i = [
  ...
  if input_message in ['8歲','八歲','キョウカ','冰川鏡華','鏡華','噴水蘿','鏡華媽媽','小倉唯' ,'傲嬌蘿','萬聖鏡華'] :
    value_i = [
  ...
  if input_message in ['美美','ミミ','茜美美','10歲','十歲','兔子','兔兔','天兔霸斷劍','人參霸斷劍','萬聖美美']:
    value_i = [
  ...
  if input_message in ['禊','ミソギ','9歲','九歲','穗高禊','炸彈','屁孩','惡作劇','萬聖禊']:
    value_i = [
...
### 好朋友社 ###
### なかよし部 ###
  if input_message in ['優妮們','好朋友社','なかよし部','好朋友部']:
    value_i = [
  ...
  if input_message in ['優妮','優尼','ユニ','前輩','優妮先輩','優妮學姊','真行寺由仁'] :
    value_i = [
  ...
  if input_message in ['克蘿依','黑江花子','花子','クロエ','華哥','不良','B80']:
    value_i = [
  ...
  if input_message in ['琪愛兒','風間千惠瑠','チエル','切嚕','ちぇるーん']:
    value_i = [
  ...
  if input_message == '空有無用知識的戀母情結小矮子':
    value_i = [
...
### ドラゴンズネスト ###
### 龍族巢穴 ###
  if input_message in ['龍族巢穴','ドラゴンズネスト']:
    value_i = [
  ...
  if input_message in ['嘉夜','カヤ','鬼道嘉夜','卡雅','龍拳']:
    value_i = [
  ...
  if input_message in ['祈梨','イノリ','一之瀨祈梨','祈','龍錘','龍槌']:
    value_i = [
...
### 騎士團 ###
### 王宮騎士団 ###
  if input_message in ['王宮騎士團','騎士團','王宮騎士団']:
    value_i = [
  ...
  if input_message in ['純','黑騎','ジュン','白銀純','黑Saber','泳裝純']:
    value_i = [
  ...
  if input_message in ['智','トモ','御久間智','卜毛','禿毛','魔法少女智']:
    value_i = [
  ...
  if input_message in ['茉莉','マツリ' ,'織原茉莉','跳跳虎','萬聖茉莉']:
    value_i = [
  ...
  if input_message in ['團長','團長們','騎士團cp']:
    value_i = [
...
### 美食殿 ###
### 美食殿堂 ###
  if input_message[:3] == '美食殿' and len(input_message)<=4:
    value_i = [
  ...
  if input_message in ['凱留','接頭霸王','考','黑貓','背骨貓','背骨','背刺貓','背刺','945','臭鼬','百地希留耶','希留耶','キャル' ,'945ml','正月凱留','泳裝凱留']:
    value_i = [
  ...
  if input_message in ['佩可','吃貨','大胃王','佩可莉姆','貪吃佩可','ペコリーヌ','公主','尤絲蒂亞娜·F·阿斯特萊亞','尤絲蒂亞娜','ヤバイですね','牙敗','公主佩可','泳裝佩可']:
    value_i = [
  ...
  if input_message in ['可可蘿','可蘿','可口蘿','コッコロ','小小嚮導','媽媽','孝心','公主可可蘿','正月可可蘿','泳裝可可蘿','儀式服可可蘿']:
    value_i = [
  ...
  if input_message in ['主角','主人公','柚樹','佑樹','祐樹','騎士君','失智','ユウキ','變態的可疑分子','公主騎士','優衣最愛的']:
    value_i = [
  ...
  if input_message in ['謝菲','シェフィ','雪菲','藍龍','冰龍']:
    value_i = [
...
### 桂冠 ###
### 七冠 ###
  if input_message in ['克莉絲提娜','克里斯蒂娜','クリスティーナ','克總','誓約女君','老太婆','副團長','阿姨','製作人','聖誕克莉絲提娜']:
    value_i = [
  ...
  if input_message in ['矛依未','青蛙','ムイミ','天樓霸斷劍','諾唯姆','姆咪','正月矛依未']:
    value_i = [
  ...
  if input_message in ['似似花','ネネカ','448','nnk','現士實似似花','變貌大妃','正月似似花']:
    value_i = [
  ...
  if input_message in ['夥伴','伙伴','同伴','相棒','アイボウ','尾狗刀','尾刀狗']:
    value_i = [
  ...
  if input_message in ['拉比林斯達','ラビリスタ','模索路晶','晶','迷宮女王','迷路女王']:
    value_i = [
...
### マナリアフレンズ ###
### Manaria Friends ###
  if input_message in ['馬納歷亞','マナリアフレンズ','Manaria Friends','百合公主']:
    value_i = [
  ...
  if input_message in ['安','アン','55kg','馬納歷亞公主','宏大魔法']:
    value_i = [
  ...
  if input_message in ['露','ルゥ','眼球','補考','補考女帝']:
    value_i = [
...
### Re:ゼロから始める異世界生活 ###
### Re:0 ###
  if input_message in ['Re:從零開始的異世界生活','Re:ゼロから始める異世界生活','Re0','re0','Re:0','re:0']:
    value_i = [
  ...
  if input_message in ['愛蜜莉雅','艾蜜莉雅','愛蜜莉亞','艾蜜莉亞','エミリア','EMT','emt','莉雅']:
    value_i = [
  ...
  if input_message in ['雷姆','レム','快速動眼期']:
    value_i = [
  ...
  if input_message in ['拉姆','ラム','記憶體','快取']:
    value_i = [
  ...
  if input_message in ['碧翠絲','ベアトリス','貝蒂','碧翠子']:
    value_i = [
...
### アイドルマスターシンデレラガールズ ###
### New Generation ###
  if input_message in ['偶像大師灰姑娘女孩','アイドルマスターシンデレラガールズ','偶大','偶像大師','灰姑娘','新世代','New Generation','new generation']:
    value_i = [
  ...
  if input_message in ['凜','渋谷凛','澀谷凜','蒼之劍士']:
    value_i = [
  ...
  if input_message in ['卯月','ウヅキ','島村卯月','笑容狂魔','笑容狂魔卯月']:
    value_i = [
  ...
  if input_message in ['未央','ミオ','本田未央','醬未央']:
    value_i = [
...
### 角色 (其他) ###
### 角色 (其他) ###
  if input_message in ['吉塔','ジータ','姬塔','騎空士','團長','古戰場逃兵','古戰場','吉他']:
    value_i = [
  ...
  if input_message in ['露娜','ルナ','露那','死靈法師','好朋友']: 
    value_i = [
  ...
  if input_message in ['亞里莎','アリサ','亞里瞎','瞎子','羅莎莉亞']: 
    value_i = [
  ...
  if input_message in ['愛梅斯','DD頭子','アメス','艾梅斯']:
    value_i = [
  ...
  if input_message in ['對決','決戰','終戰','對峙']:
    value_i = [
  ...
  if input_message in ['公主連結','プリコネ','超異域公主連結','公連']:
    value_i = [
...
### アズールレーン ###
### 碧池航線 ###
  if input_message in ['碧藍航線','アズールレーン','碧池航線']: 
    value_i = [
  ...
  if input_message in ['標槍','Javelin','ジャベリン']: 
    value_i = [
  ...
  if input_message in ['拉菲','ラフィー','紅酒']: 
    value_i = [
  ...
  if input_message in ['綾波','アヤナミ','鬼神']: 
    value_i = [
  ...
  if input_message in ['獨角獸','ユニコーン'] or (input_message[:2] == '港獨' and len(input_message)<6): 
    value_i = [
...
### 心跳文學部 ###
  if input_message in ['心跳文學部','DokiDoki','Doki Doki','dokidoki','doki doki Literature Club']: 
    value_i = [
  ...
  if input_message in ['Natsuki','natsuki','夏樹']:
    value_i = [
  ...
  if input_message in ['Sayori','sayori','紗世里']: 
    value_i = [
  ...
  if input_message in ['Yuri','yuri','優里']: 
    value_i = [
...
### 請問您今天要來點兔子嗎？ ###
### ご注文はうさぎですか？ ###
  if input_message in ['智乃','香風智乃','點兔','チノ']:
    value_i = [
...
### 魔女の旅々 ###
### 魔女之旅 ###
  if input_message in ['魔女之旅','魔女の旅々','伊蕾娜','灰之魔女','イレイナ']: 
    value_i = [
...
### 抄襲偷個資 ###
### パイモン ###
  if input_message in ['派蒙','原神','パイモン','應急食品','抄襲遊戲']: 
    value_i = [
...
### VTuber ###
### VTuber ###
  if input_message in ['gura','Gura','GURA','鯊鯊','サメちゃん','グラ','古拉']: 
    value_i = [
  ...
  if input_message in ['Amelia','Ame','ame','AME','watson','Watson','華生']: 
    value_i = [
  ...
  if input_message in ['Ina','ina',"Ina'nis"]: 
    value_i = [
  ...
  if input_message in ['潤羽るしあ','るしあ','Rushia','rushia','潤羽露西婭','露西婭','初號機']: 
    value_i = [
  ...
  if input_message in ['百鬼あやめ','あやめ','百鬼綾目']: 
    value_i = [
  ...
  if input_message in ['湊あくあ','あくあ','aqua','Aqua','湊阿庫婭']: 
    value_i = [
  ...
  if input_message in ['兎田ぺこら','ぺこら','兔田佩克拉','兔田佩可拉']: 
    value_i = [
  ...
  if input_message in ['常闇トワ','トワ','TMT','常闇永遠']: 
    value_i = [
  ...
  if input_message in ['雪花ラミィ','ラミィ','雪花菈米','菈米']: 
    value_i = [
